...
export class StreamableHTTPServerTransport {
    ...
    async handlePostRequest(req, res, parsedBody) {
        ...
        try {
            ...
            const acceptHeader = req.headers.accept;
            // The client MUST include an Accept header listing application/json or */* as a supported content type.
            // The `text/event-stream` media type is only required when Server-Sent Events are used.
            if (!(acceptHeader === null || acceptHeader === void 0 ? void 0 : acceptHeader.includes("application/json")) && !(acceptHeader === null || acceptHeader === void 0 ? void 0 : acceptHeader.includes("*/*"))) {
                res.writeHead(406).end(JSON.stringify({
                    jsonrpc: "2.0",
                    error: {
                        code: -32000,
            ...
            if (!hasRequests) {
                ...
                if (!this._enableJsonResponse) {
                    if (!(acceptHeader === null || acceptHeader === void 0 ? void 0 : acceptHeader.includes("text/event-stream")) && !(acceptHeader === null || acceptHeader === void 0 ? void 0 : acceptHeader.includes("*/*"))) {
                        res.writeHead(406).end(JSON.stringify({
                            jsonrpc: "2.0",
                            error: {
                                code: -32000,
